...
------------------------------------------------------------------------------*/
select isim as isimOrSehir, maas from personel where maas>4000 union
...
/* -----------------------------------------------------------------------------
  ORNEK4: 5000’den az maas alanlarin bilgileri ile, Honda calisani olmayanlarin bilgilerini
...
union select isim,sehir from personel where sehir<> 'istanbul';
...
select sehir as sehirVeTel ,maas as maasVeCocukSayisi from personel where id=123456789 union
