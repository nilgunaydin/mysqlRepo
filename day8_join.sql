...
select sirket_isim, siparis_id,siparis_tarihi,sip.sirket_id
from sirketler sir
...
------------------------------------------------------------------------------*/   
 ...
 select * from sirketler right join siparisler on sirketler.sirket_id = siparisler.sirket_id;
...
/* -----------------------------------------------------------------------------
  ...
  siparis_id ve siparis_tarihleri listeleyen bir sorgu yaziniz.
------------------------------------------------------------------------------*/ 
 select * from sirketler right join siparisler on sirketler.sirket_id = siparisler.sirket_id union
 select * from sirketler left join siparisler on sirketler.sirket_id = siparisler.sirket_id;
...
on p.bolum_id=b.bolum_id
ORDER BY b.bolum_isim desc,p.maas ; -- null olan bolumleri getirmedi.
