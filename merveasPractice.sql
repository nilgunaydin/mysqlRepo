...
-- Veli Han'ın maaşını en yüksek maaştan yüzde 20 daha azına artirin
UPDATE WORKER
...
-- update worker set worker_salary=((select max(worker_salary)*80)/100 +  worker_salary) where worker_name="veli han";

-- Ali Can'ın maaşını en düşük maaştan yüzde 30 daha fazla duşurun
